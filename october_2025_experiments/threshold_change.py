...
def main():
    ...
    for threshold in range(80, 81, 10):
        ...
        for batch_start in range(0, total_repeats, repeats_per_batch):
            ...
            filename = f'Hybrid_data_threshold_{threshold}_batch_{batch_start // repeats_per_batch + 1}'
            hybrid_model.save_simulation_data(
                Hybrid_SSA, Hybrid_PDE, Hybrid_combined,
                datadirectory='data',
                filename=filename
            )
