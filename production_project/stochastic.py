...
"""Created 1/10/2024 as new project file for full stochastic model"""
...
class Stochastic:
    ...
    def run_simulation(self,number_of_repeats):
        ...
        for _ in tqdm(range(number_of_repeats),desc="Running the simulations"):
            SSA_current= self.stochastic_simulation(SSA_initial.copy())
    ...
    def save_simulation_data(self,SSA_grid, datadirectory='data'):
